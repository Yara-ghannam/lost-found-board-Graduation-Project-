    ...
    <div class="container py-5">
        <div class="row mb-4">
            ...
            <div class="col-lg-4 text-end">
                <a href={{ route('report-lost') }} class="btn btn-danger">
            ...
            @foreach ($lostItems as $item)
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 shadow-sm item-card" data-title="{{ strtolower($item->item->title) }}"
                        ...
                        <img src="{{ $item->item->image_url }}" class="card-img-top" alt="Image"
                            style="object-fit: contain; width: 100%; height: 250px;">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <h5 class="card-title mb-0">{{ $item->item->title }}</h5>
                                <span class="badge bg-danger">{{ $item->post_type }}</span>
                            </div>
...
<script>
    ...
    function openComments(postId) {
        ...
        let commentsHtml = '';
        let comments = @json($lostItems); // Make sure this is your data source
