        ...
        <div class="row align-items-center min-vh-100">
            ...
            <div class="col-lg-6 text-white">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="<?php echo e(route('report-lost')); ?>" class="btn btn-outline-light btn-lg ">
                         <i class="fas fa-search-minus"></i> Report Lost
                    </a>

                    <a href="<?php echo e(route('report-found')); ?>" class="btn btn-success btn-lg">
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Lost-Found-main\resources\views/home.blade.php ENDPATH**/ ?>