        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Route::is('home') ? 'active text-white fw-bold' : ''); ?>"
                            href="<?php echo e(route('home')); ?>">Home</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Route::is('lost-items') ? 'active text-white fw-bold' : ''); ?>"
                            href="<?php echo e(route('lost-items')); ?>">Lost Items</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Route::is('found-items') ? 'active text-white fw-bold' : ''); ?>"
                            href="<?php echo e(route('found-items')); ?>">Found Items</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link ms-2 px-3 <?php echo e(Route::is('report-lost') ? 'active text-white fw-bold' : ''); ?>"
                            href="<?php echo e(route('report-lost')); ?>">Report Lost</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link ms-2 px-3 <?php echo e(Route::is('report-found') ? 'active text-white fw-bold' : ''); ?>"
                            href="<?php echo e(route('report-found')); ?>">Report Found</a>
                    </li>

                    <?php if(Session::get('is_logged_in')): ?>
                        <li class="nav-item">
                            <a class="nav-link ms-2 px-3 <?php echo e(Route::is('posts.*') ? 'active' : ''); ?>"
                                href="<?php echo e(route('posts.index')); ?>">My Posts</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if(Session::get('role') == 'admin'): ?>
                        <li class="nav-item dropdown ">
                            ...
                            <?php echo e(Route::is('dashboard') || Route::is('users.*') ? 'active' : ''); ?>"
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                <li>
                                    <a class="dropdown-item <?php echo e(Route::is('dashboard') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('dashboard')); ?>">
                                        Posts
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo e(Route::is('users') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('users')); ?>">
                                        Users
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo e(Route::is('claims') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('claims')); ?>">
                                        Claims Status
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="d-flex ms-lg-3 mt-2 mt-lg-0">
                        <?php if(Session::get('is_logged_in')): ?>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end bg-dark text-white"
                                    ...
                                    <!-- Update Profile -->
                                    <li>
                                        <a href="<?php echo e(route('your.profile')); ?>"
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('show-login')); ?>" class="btn btn-outline-light me-2">Login</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end bg-dark text-white p-0"
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="px-2 py-1 bg-dark" id="notification-<?php echo e($n->id); ?>">
                                        ...
                                        <div class="alert alert-secondary alert-dismissible fade show mb-1 py-2 px-3"
                                            ...
                                            <div class="small">
                                                <?php echo e($n->notification_text); ?>
                                            ...
                                            <button type="button" class="btn-close btn-close-white mark-read-btn"
                                                data-id="<?php echo e($n->id); ?>" aria-label="Close">
                                            </button>
                                        </div>
...
<?php /**PATH C:\xampp\htdocs\projects\Lost-Found-main\resources\views/layout/master.blade.php ENDPATH**/ ?>