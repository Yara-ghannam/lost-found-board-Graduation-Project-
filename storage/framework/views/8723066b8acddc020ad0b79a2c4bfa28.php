            ...
            <div class="col-lg-8">
                <div class="card shadow-lg">
                    ...
                    <div class="card-body p-5">
                        <form action=<?php echo e(route('store-report-found')); ?> method="POST" enctype="multipart/form-data"
                            id="foundItemForm">
                            <?php echo csrf_field(); ?>
                            <div class="row mb-4">
                                <div class="col-md-6">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href=<?php echo e(route('found-items')); ?> class="btn btn-primary">View Found Items</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Lost-Found-main\resources\views/item/report-found.blade.php ENDPATH**/ ?>