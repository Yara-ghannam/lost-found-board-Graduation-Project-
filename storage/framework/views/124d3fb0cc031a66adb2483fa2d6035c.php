    ...
    <div class="container py-5">
        <div class="row mb-4">
            ...
            <div class="col-lg-4 text-end">
                <a href=<?php echo e(route('report-found')); ?> class="btn btn-success">
            ...
            <?php $__currentLoopData = $foundItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100 shadow-sm item-card" data-title="<?php echo e(strtolower($item->item->title)); ?>"
                        ...
                        data-date="<?php echo e($item->created_at->format('Y-m-d')); ?>"> <img src="<?php echo e($item->item->image_url); ?>"
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                ...
                                <span class="badge bg-success"><?php echo e($item->post_type); ?></span>
                            </div>
...
function openComments(postId) {
    ...
    let commentsHtml = '';
    let comments = <?php echo json_encode($foundItems, 15, 512) ?>; // Make sure this is your data source
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Lost-Found-main\resources\views/item/found-items.blade.php ENDPATH**/ ?>