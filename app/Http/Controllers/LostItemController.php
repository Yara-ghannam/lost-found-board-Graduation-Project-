...
class LostItemController extends Controller
{
    ...
    public function indexItems()
    {
        ...
        return view('item.lost-items', compact('lostItems', 'claims', 'categories'));
    }
    ...
    public function reportLost()
    {
        ...
        return view('item.report-lost', compact('categories'));
    }
    ...
    public function storeReportLost(Request $request)
    {
        ...
        return redirect()->route('lost-items')->with('success', 'Lost item reported successfully!');
    }
